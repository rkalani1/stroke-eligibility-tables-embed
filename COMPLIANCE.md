...
Public-use boundary: Public reference/code preview only. Do not embed this personal GitHub Pages URL into official, intranet, EHR, patient-facing, or recruitment pages without formal approval.
